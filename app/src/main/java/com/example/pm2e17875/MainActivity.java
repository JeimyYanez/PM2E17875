...
import com.example.pm2e17875.configuraciones.Pais;
import com.example.pm2e17875.configuraciones.SQLiteConexion;
import com.example.pm2e17875.configuraciones.Transacciones;
...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner spPais;
    ImageView foto;
    Button btnSlcFoto,btnTomarFoto,btnContactoSalvados,btnGuardarContacto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foto = (ImageView) findViewById(R.id.imageView2);
         ...
         btnContactoSalvados = (Button) findViewById(R.id.btnListar);
